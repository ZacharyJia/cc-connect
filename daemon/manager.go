...
func DefaultLogFile() string {
	...
	return filepath.Join(home, ".cx-connect", "logs", "cx-connect.log")
}

func DefaultDataDir() string {
	home, _ := os.UserHomeDir()
	return filepath.Join(home, ".cx-connect")
}

// Meta stores local daemon settings so status/logs can run without parsing service definitions.
type Meta struct {
